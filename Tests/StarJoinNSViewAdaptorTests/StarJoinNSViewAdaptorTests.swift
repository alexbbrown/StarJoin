//
//  StarJoinNSViewAdaptorTests.swift
//  StarJoinNSViewAdaptorTests
//
...
@testable import StarJoinNSViewAdaptor

class StarJoinNSViewAdaptorTests: XCTestCase {
    ...
    override func setUp() {
        ...
        root = NSView(frame:CGRect(x:0, y:0, width: 1024, height: 768))
    ...
    func testSelectionOneEnter() {
        ...
        enterSelection.append { (d, i) -> NSView in
            return NSView()
        }
